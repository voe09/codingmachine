...
The profile also separated other costs: expert parallelism via ring all-gather was expensive, grouped matrix multiplication had some but not primary headroom, and attention and cross-entropy were slower than ideal without dominating total step time. This is why optimizing the most conspicuous kernel would not necessarily speed the complete training step. [Two-node profile](https://marin-discord.pages.dev/#1399998407657001062/1518855948100177991).
