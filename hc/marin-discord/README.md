...
The initial summaries were built from selected messages, not a complete reading of the 36,257-message export. A later chronological review covered every exported message body in [#data-rewriting](data-rewriting.md) and [#mtp](mtp.md); the other channel pages still require that level of review. Their archive-size headers do not indicate complete analysis. The expanded [#infra](infra.md) and [#reinforcement-learning](reinforcement-learning.md) pages incorporate additional discussions but remain selective. Links to an issue, paper, plot, or document in Discord do not mean that external artifact was read or verified here.
